  ...
  return (
    <div className="min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-3xl bg-white rounded-lg shadow p-8 sm:p-12">
        ...
        <p className="text-lg font-semibold text-gray-700">PGME (PGME Medical Education LLP)</p>
        ...
        <p className="text-gray-700 mb-3">We automatically collect certain device information when you use the Platform:</p>
        <ul className="list-disc pl-6 text-gray-700 space-y-1 mb-6">
        ...
        <p className="text-gray-700 mb-3">We collect information about how you interact with the Platform:</p>
        <ul className="list-disc pl-6 text-gray-700 space-y-1 mb-6">
        ...
        <p className="text-gray-700 mb-4">The Platform requests the following device permissions:</p>
        ...
        <p className="text-gray-700 mb-4">You can view and update your profile information at any time through the Edit Profile section in the Platform.</p>

        <h3 className="text-lg font-semibold text-gray-800 mb-2">7.2 Device Session Management</h3>
        <p className="text-gray-700 mb-4">You can view all active sessions and remotely logout from any device through the Platform settings.</p>
        ...
        <p className="text-gray-700 mb-6">Your continued use of the Platform after any changes constitutes your acceptance of the updated Privacy Policy.</p>
        ...
        <p className="text-gray-700 mb-3">This policy shall be governed by the laws of India.</p>
        <p className="text-gray-700 mb-6">All disputes shall be subject to the exclusive jurisdiction of courts located in Jalandhar, Punjab.</p>
        ...
        <div className="text-gray-700 mb-6">
          <p className="font-semibold">PGME Medical Education LLP</p>
